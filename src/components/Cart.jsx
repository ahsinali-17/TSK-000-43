...
const Cart = () => {
  ...
  return (
    <div className="products w-[90vw] m-auto flex flex-wrap justify-center gap-6 mt-6">
       {cart.map((item) => {
            return(
            <div key={item.id} className='flex flex-col gap-5 items-center w-[45%] md:w-1/4 h-[35vh] lg:h-[50vh] border border-black rounded-xl p-6 cursor-pointer shadow-lg hover:shadow-gray-500'>
